...
# Standardize data
Maybe standardizing the data will improve the fit.
```{r}
model_standard <- model_data_no_na %>% mutate_each_(list(~scale(.) %>% as.vector),
                                  vars = c("revol_util", "inq_last_6mths", "annual_inc", "funded_amnt_inv", "revol_bal", "dti", "pub_rec", "delinq_2yrs", "total_pymnt", "total_acc", "open_acc", "acc_now_delinq"))
```
