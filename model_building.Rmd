...
library(caret) # another group said this was very helpful for getting pretty data that got them an MSE of 8
...
my_data$emp_length <- as.integer(ordered(my_data$emp_length, levels = c("n/a", "< 1 year", "1 year", "2 years", "3 years", "4 years", "5 years", "6 years", "7 years", "8 years", "9 years", "10+ years"))) # does this need to consider na as unemployed?
